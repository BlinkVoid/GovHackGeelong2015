...
class map2():	
	...
	def __init__(self, location, value):
		...
		self.nodeName = []
		#==============static declearation=============
		pipLineNetVariable = pipelineNetwork.pipLineNetVariableDeclaration
		pipLineNetVariableDeclaration = pipelineNetwork.pipLineNetVariable
		#print (pipLineNetVariable)
		#==============================================
		...
		#===================changes
		plotPolylines = pipLineVariable 
		plotPolylines += pipLineNetVariable 
		plotPolylines += ('''
		var flightPath=new google.maps.Polyline({
		  path:pipLine,
		  strokeColor:"#0063BD",
		...
		# })
		# '''
		plotPolylines += '''flightPath.setMap(map);
		#networkPath.setMap(map);
		'''
		#=======================
		self.api = '''
		<script>'''
		self.api += variableDeclaration + pipLineNetVariableDeclaration
		self.api += '''
			var map;
